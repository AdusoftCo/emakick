   ...
   <body>
        ...
        <div class="container">
                <div class="tit-5 container ">
                    ...
                    <h4 class="tit mt-5 display-3 animate__animated animate__flipInX" style="font-size :4rem !important;">Hola! Soy  <span style="font-family: 'Comforter Brush', cursive;">Jane Fernandez,</span><br></h4>
    ...
    <footer>
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Diseñado por Jane Fernandez</a>
            </li>
