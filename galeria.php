...
<?php if($_POST){#si hay envio de datos, los inserto en la base de datos  
    ...
    $sql="INSERT INTO `proyectos` (`id`, `nombre`, `imagen`, `url`, `descripcion`) VALUES (NULL, '$nombre_proyecto' , '$imagen', '$url', '$descripcion')";
    ...
    <div style="background-color:#a2a2a2;">
        <div class="row d-flex justify-content-center mb-5">
            <div class="col-md-10 col-sm-6">
                <table class="table tabla__galeria" style="background-color:#a2a2a2;">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Imagen</th>
                 ...
                 foreach($proyectos as $proyecto){ ?>
                    <div class="col card__mobile  mb-4">
                        <div class="card border border-3 shadow w-100">
                            ...
                            <div class="card-body">
                                <p class="card-text text-blue"><?php echo $proyecto['url'];?></p>
